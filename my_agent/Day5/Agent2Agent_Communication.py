...
file_path = os.path.join(tmp_dir, "product_catalog_server.py")

with open(file_path, "w") as f:
    f.write(product_catalog_agent_code)

cwd_path = os.path.abspath(tmp_dir)
...
server_process = subprocess.Popen(
    ...
    cwd=cwd_path,  # Run from /tmp where the file is
...
async def main():
    ...
    await test_a2a_communication("I'm looking for a laptop. Can you compare the Dell XPS 15 and MacBook Pro 14 for me?")
    # Test specific product inquiry
    await test_a2a_communication("Do you have the Sony WH-1000XM5 headphones? What's the price?")
